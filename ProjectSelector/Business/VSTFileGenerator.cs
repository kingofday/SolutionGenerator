namespace ProjectSelector
{
    ...
    public static class VSTFileGenerator
    {
        private static string vsTempate =
            "<VSTemplate Version=\"3.0.0\" xmlns=\"http://schemas.microsoft.com/developer/vstemplate/2005\" Type=\"Project\">" + Environment.NewLine +
                  "<TemplateData>" + Environment.NewLine +
                    "<Name>{0}</Name>" + Environment.NewLine +
                    "<Description>&lt;No description available&gt;</Description>" + Environment.NewLine +
                    "<ProjectType>CSharp</ProjectType>" + Environment.NewLine +
                    "<ProjectSubType>" + Environment.NewLine +
                    "</ProjectSubType>" + Environment.NewLine +
                    "<SortOrder>1000</SortOrder>" + Environment.NewLine +
                  ...
                  "<TemplateContent>" + Environment.NewLine +
                    "<Project TargetFileName = \"$ext_safeprojectname$.Dashboard.csproj\" File=\"{0}.csproj\" ReplaceParameters=\"true\">" + Environment.NewLine +
                      "{1}" +
                    "</Project\r\n>" +
                  "</TemplateContent>" + Environment.NewLine +
                "</VSTemplate>";
        ...
        private static string mainVsTemplate =
            "<?xml version=\"1.0\" encoding=\"utf-8\"?>" + Environment.NewLine +
                "<VSTemplate Version=\"3.0.0\" Type=\"ProjectGroup\" xmlns=\"http://schemas.microsoft.com/developer/vstemplate/2005\" xmlns:sdk=\"http://schemas.microsoft.com/developer/vstemplate-sdkextension/2010\">" + Environment.NewLine +
                  "<TemplateData>" + Environment.NewLine +
                    "<Name>Gnu Asp.Net Project</Name>" + Environment.NewLine +
                    "<Description>Gnu Base Project</Description>" + Environment.NewLine +
                    "<Icon>gnu.ico</Icon>" + Environment.NewLine +
                    "<ProjectType>CSharp</ProjectType>" + Environment.NewLine +
                    "<RequiredFrameworkVersion>2.0</RequiredFrameworkVersion>" + Environment.NewLine +
                    "<SortOrder>1000</SortOrder>" + Environment.NewLine +
                    "<TemplateID>64a58ed4-427f-4225-aa26-05481c4dc8ba</TemplateID>" + Environment.NewLine +
                    "<CreateNewFolder>true</CreateNewFolder>" + Environment.NewLine +
                    "<DefaultName>Kingofdat.ir</DefaultName>" + Environment.NewLine +
                    "<ProvideDefaultName>true</ProvideDefaultName>" + Environment.NewLine +
                  "</TemplateData>" + Environment.NewLine +
                  "<TemplateContent>" + Environment.NewLine +
                   ...
                   "</TemplateContent>" + Environment.NewLine +
                   @"<WizardExtension>
                        <Assembly>SolutionGenerator, Version=1.0.0.0, Culture=Neutral, PublicKeyToken=332971b9318ce7dc</Assembly>
                        <FullClassName>SoultionGenerator.WizardImplementation</FullClassName>
                    </WizardExtension>
                </VSTemplate>";
        ...
        public static string SolutionFullPath = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName, name;
        ...
        public static void Genarate(string content, string projName)
        {
            ...
            using (TextWriter tw = new StreamWriter(filePath))
                tw.Write(string.Format(vsTempate, Configs.prefix + projName, content));
        }
        ...
        public static void Replacer(string filePath)
        {
            ...
            //text = text.Replace("YourPrefix", "$ext_safeprojectname$");
            //FileInfo fileInfo = new FileInfo(filePath);
            //fileInfo.IsReadOnly = false;
